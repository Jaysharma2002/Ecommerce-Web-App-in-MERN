...
function AdminContent({selectedCategory,searchProduct}){
    ...
    useEffect(()=>{
        ...
        const fetch=async()=>{
            try {
                ...
                await axios.get("https://ecommerce-web-app-in-mern-1.onrender.com/api/product/fetch").then((response)=>{
    ...
    const AddProduct=async()=>{
        const response=await axios.post("https://ecommerce-web-app-in-mern-1.onrender.com/api/product/create",{
    ...
    const UpadateProduct=async()=>{
        ...
        const response=await axios.put(`https://ecommerce-web-app-in-mern-1.onrender.com/api/product/update/${isEdit}`,{
            title:newProduct.title,
            images:newProduct.images,
            description:newProduct.description,
            price:newProduct.price,
    ...
    const handleDelete=async(id)=>{
        await axios.delete(`https://ecommerce-web-app-in-mern-1.onrender.com/api/product/delete/${id}`)
